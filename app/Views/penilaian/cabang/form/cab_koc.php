            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Penilaian Kepala Operasional Cabang (KOC)</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <section class="content">
        <div class="card card-primary">
            ...
            <div class="card-body" style="overflow-x: auto">
                <form action="<?= base_url('penilaian/process_kc/ka_koc') ?>" method="POST">
                    <?php csrf_field(); ?>
                    <?php
        ...
        <div class="card card-primary">
            <div class="card-header">
                <div class="card-title">
                    Penilaian Sasaran Bisnis/Kinerja
                </div>
            </div>
            <div class="card-body">
                ...
                <table class="table table-bordered" style="margin-top: 20px;">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" class="form-control" name="realisasi_sb1" id="realisasi_sb1" minlength="8" onkeyup="sb1();" required>
                        </td>
                    </tr>
                    <tr>
                ...
                <table class="table table-bordered" style="margin-top: 20px;">
                    ...
                    <tr>
                        <td width="30%">Realisasi</td>
                        <td>
                            <input type="text" class="form-control" name="realisasi_sb2" id="realisasi_sb2" minlength="8" onkeyup="sb2();" required>
                        </td>
                    </tr>
                    <tr>
                        <td width="30%">Bobot </td>
                ...
                <table class="table table-bordered" style="margin-top: 20px;">
                    ...
                    <tr>
                        <td width="30%">Realisasi</td>
                        <td>
                            <input type="text" class="form-control" name="realisasi_sb3" id="realisasi_sb3" minlength="8" onkeyup="sb3();" required>
                        </td>
                    </tr>
                    <tr>
                        <td width="30%">Bobot </td>
                ...
                <table class="table table-bordered" style="margin-top: 20px;">
                    ...
                    <tr>
                        <td width="30%">Realisasi</td>
                        <td>
                            <input type="text" class="form-control" name="realisasi_sb4" id="realisasi_sb4" minlength="8" onkeyup="sb4();" required>
                        </td>
                    </tr>
                    <tr>
                        <td width="30%">Bobot </td>
                ...
                <table class="table table-bordered" style="margin-top: 20px;">
                    ...
                    <tr>
                        <td width="30%">Realisasi</td>
                        <td>
                            <input type="text" class="form-control" name="realisasi_sb5" id="realisasi_sb5" minlength="8" onkeyup="sb5();" required>
                        </td>
                    </tr>
                    <tr>
                        <td width="30%">Bobot </td>
                    ...
                    <div class="col-md-6">
                        <table class="table table-bordered" style="margin-bottom: 25px;">
                            <tr>
                                ...
                                <td><input type="number" class="form-control" name="nilai_npf" id="nilai_npf" onkeyup="npf();" onChange="npf(this);" placeholder="Masukkan Nilai NPF" required></td>
                            </tr>
                            <tr>
        ...
        <div class="card card-primary">
            ...
            <div class="card-body">
                ...
                <table class="table table-bordered" style="margin-bottom: 25px;">
                    ...
                    <tr>
                        <td colspan="3">
                            <input type="text" class="form-control" name="alasan_kupel" id="alasan_kupel" minlength="10" placeholder="Masukkan Alasan dan Contoh..." required>
                        </td>
                    </tr>
                </table>
                ...
                <table class="table table-bordered" style="margin-bottom: 25px;">
                    ...
                    <tr>
                        <td colspan="3">
                            <input type="text" class="form-control" minlength="10" name="alasan_disiplin" id="alasan_disiplin" placeholder="Masukkan Alasan dan Contoh..." required>
                        </td>
                    </tr>
                </table>
                ...
                <table class="table table-bordered" style="margin-bottom: 25px;">
                    ...
                    <tr>
                        <td colspan="3">
                            <input type="text" class="form-control" name="alasan_inisiatif" id="alasan_inisiatif" minlength="10" placeholder="Masukkan Alasan dan Contoh..." required>
                        </td>
                    </tr>
                </table>
                ...
                <table class="table table-bordered" style="margin-bottom: 25px;">
                    ...
                    <tr>
                        <td colspan="3">
                            <input type="text" class="form-control" name="alasan_integritas" id="alasan_integritas" minlength="10" placeholder="Masukkan Alasan dan Contoh..." required>
                        </td>
                    </tr>
                </table>
                ...
                <table class="table table-bordered" style="margin-bottom: 25px;">
                    ...
                    <tr>
                        <td colspan="3">
                            <input type="text" class="form-control" name="alasan_kerjasama" id="alasan_kerjasama" minlength="10" placeholder="Masukkan Alasan dan Contoh..." required>
                        </td>
                    </tr>
                </table>
