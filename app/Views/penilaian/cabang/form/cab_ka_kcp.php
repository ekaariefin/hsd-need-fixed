            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Penilaian Kepala Cabang Pembantu (KCP)</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <section class="content">
        <div class="card card-primary">
            ...
            <div class="card-body" style="overflow-x: auto">
                <form action="<?= base_url('penilaian/process_kc/ka_kcp') ?>" method="POST">
                    <?php csrf_field(); ?>
                    <?php
            ...
            <div class="card-body">
                ...
                <table class="table table-bordered" style="margin-top: 20px;">
                    ...
                    <tr>
                        <td width="30%">Bobot </td>
                        <td>
                            <input type="text" class="form-control" name="bobot_sb3" id="bobot_sb3" value="<?= $getSarbis['bobot_sarbis3']; ?>" onkeyup="sb3();" readonly>
                        </td>
                    </tr>
                    <tr>
                        <td width="30%">Nilai</td>
        ...
        <div class="card card-primary">
            ...
            <div class="card-body">
                ...
                <table class="table table-bordered" style="margin-bottom: 25px;">
                    ...
                    <tr>
                        <td colspan="3">
                            <input type="text" minlength="10" class="form-control" name="alasan_kemampuan_manajerial" id="alasan_kemampuan_manajerial" placeholder="Masukkan Alasan dan Contoh..." required>
                        </td>
                    </tr>
                </table>
            ...
            <div class="card-body">
                <table class="table table-bordered">
                    <tr>
                        ...
                        <td>
                            <input name="hal_menonjol" class="form-control" minlength="10" rows="1" required>
                        </td>
                    </tr>
                    <tr>
                        <td width="30%">Hal-Hal Yang Perlu Ditingkatkan</td>
                        <td>
                            <input name="hal_peningkatan" class="form-control" minlength="10" rows="1" required>
                        </td>
                    </tr>
                    <tr>
                        <td width="30%">Training/Pelatihan Yang Dibutuhkan</td>
                        <td>
                            <input type="text" class="form-control" name="req_training" id="req_training" required>
                        </td>
                    </tr>
                </table>
            </div>
