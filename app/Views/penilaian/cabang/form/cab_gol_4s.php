    ...
    <section class="content">
        ...
        <div class="card card-primary">
            ...
            <div class="card-body" style="overflow-x: auto">
                <form action="<?= base_url('penilaian/process_kc/4S') ?>" method="POST">
                    <?php
        ...
        <div class="card card-primary">
            ...
            <div class="card-body">
                ...
                <table class="table table-bordered" style="margin-bottom: 25px;">
                    ...
                    <tr>
                        <td colspan="3">
                            <input type="text" minlength="10" class="form-control" name="alasan_pengetahuan_jabatan" id="alasan_pengetahuan_jabatan" placeholder="Masukkan Alasan dan Contoh...">
                        </td>
                    </tr>
                </table>
                ...
                <table class="table table-bordered" style="margin-bottom: 25px;">
                    ...
                    <tr>
                        <td colspan="3">
                            <input type="text" minlength="10" class="form-control" name="alasan_kualitas_kerja" id="alasan_kualitas_kerja" placeholder="Masukkan Alasan dan Contoh...">
                        </td>
                    </tr>
                </table>
                ...
                <table class="table table-bordered" style="margin-bottom: 25px;">
                    ...
                    <tr>
                        <td colspan="3">
                            <input type="text" minlength="10" class="form-control" name="alasan_adaptasi" id="alasan_adaptasi" placeholder="Masukkan Alasan dan Contoh...">
                        </td>
                    </tr>
                </table>
                ...
                <table class="table table-bordered" style="margin-bottom: 25px;">
                    ...
                    <tr>
                        <td colspan="3">
                            <input type="text" minlength="10" class="form-control" name="alasan_kemampuan_komunikasi" id="alasan_kemampuan_komunikasi" placeholder="Masukkan Alasan dan Contoh...">
                        </td>
                    </tr>
                </table>
            </div>
