            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Penilaian Account Officer (AO)</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <section class="content">
        <div class="card card-primary">
            ...
            <div class="card-body" style="overflow-x: auto">
                <form action="<?= base_url('penilaian/process_kc/ao_reg') ?>" method="POST">
                    <?php csrf_field(); ?>
                    <?php
        ...
        <div class="card card-primary">
            <div class="card-header">
                <div class="card-title">
                    Penilaian NPF Audit dan Dokumen Kurang
                </div>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                        <table class="table table-bordered" style="margin-bottom: 25px;">
                            ...
                            <tr>
                                <td style="width: 40%;">Nilai Dokumen Kurang<br /><br /></td>
                                <td>
                                    <select name="nilai_dok" class="form-control" id="nilai_dok" onkeyup="dok();" onChange="dok(this);" required>
                                        <option hidden value="">--Pilih Status Nilai--</option>
                    ...
                    <div class="col-md-6">
                        <table class="table table-bordered" style="margin-bottom: 25px;">
                            ...
                            <tr>
                                <td>Bobot Dokumen Kurang<br><small><i>nilai akan terisi otomatis</i></small></td>
                                <td><input type="number" class="form-control" name="bobot_dok" id="bobot_dok" readonly></td>
                            </tr>
                        </table>
                    </div>
                </div>
        ...
        <div class="card card-primary">
            ...
            <div class="card-body">
                ...
                <table class="table table-bordered" style="margin-bottom: 25px;">
                    ...
                    <tr>
                        <td colspan="3">
                            <input type="text" minlength="10" class="form-control" name="alasan_kupel" id="alasan_kupel" placeholder="Masukkan Alasan dan Contoh..." required></textarea>
                        </td>
                    </tr>
                </table>
            ...
            <div class="card-body">
                <table class="table table-bordered">
                    <tr>
                        ...
                        <td>
                            <textarea name="hal_menonjol" class="form-control" rows="1"></textarea>
                        </td>
                    </tr>
                    <tr>
                        <td width="30%">Hal-Hal Yang Perlu Ditingkatkan</td>
                        <td>
                            <textarea name="hal_peningkatan" class="form-control" rows="1"></textarea>
                        </td>
                    </tr>
                    <tr>
...
<script>
    ...
    function dok() {
        var nilai = document.getElementById('nilai_dok').value;
        var bobot = (nilai == 'Ada') ? 0.50 : 0;
        if (!isNaN(bobot)) {
            document.getElementById('bobot_dok').value = bobot;
        }
    }
</script>
<script>
