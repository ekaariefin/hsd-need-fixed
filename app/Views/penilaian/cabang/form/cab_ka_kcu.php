...
<div class="content-wrapper">
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h4>Penilaian Kinerja Kantor Cabang</h4>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item active">Penilaian Kepala Cabang (KCU)</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <section class="content">
        <div class="card card-primary">
            ...
            <div class="card-body" style="overflow-x: auto">
                <form action="<?= base_url('penilaian/process_kc/ka_kc') ?>" method="POST">
                    <?php csrf_field(); ?>
                    <?php
                    require "cab_form_header.php";
                    ?>
            </div>
        </div>
        ...
        <div class="card card-primary">
            <div class="card-header">
                <div class="card-title">
                    II. Penilaian Sasaran Bisnis/Kinerja
                </div>
            </div>
            <div class="card-body">
                ...
                <table class="table table-bordered" style="margin-top: 20px;">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" class="form-control" name="realisasi_sb1" id="realisasi_sb1" onkeyup="sb1();" minlength="8" required>
                        </td>
                    </tr>
                    <tr>
                ...
                <table class="table table-bordered" style="margin-top: 20px;">
                    ...
                    <tr>
                        <td width="30%">Realisasi</td>
                        <td>
                            <input type="text" class="form-control" name="realisasi_sb2" id="realisasi_sb2" onkeyup="sb2();" minlength="8" required>
                        </td>
                    </tr>
                    <tr>
                        <td width="30%">Bobot </td>
                ...
                <table class="table table-bordered" style="margin-top: 20px;">
                    ...
                    <tr>
                        <td width="30%">Realisasi</td>
                        <td>
                            <input type="text" class="form-control" name="realisasi_sb3" id="realisasi_sb3" onkeyup="sb3();" minlength="8" required>
                        </td>
                    </tr>
                    <tr>
                        <td width="30%">Bobot </td>
                ...
                <table class="table table-bordered" style="margin-top: 20px;">
                    ...
                    <tr>
                        <td width="30%">Realisasi</td>
                        <td>
                            <input type="text" class="form-control" name="realisasi_sb4" id="realisasi_sb4" onkeyup="sb4();" minlength="8" required>
                        </td>
                    </tr>
                    <tr>
                        <td width="30%">Bobot </td>
                ...
                <table class="table table-bordered" style="margin-top: 20px;">
                    ...
                    <tr>
                        <td width="30%">Realisasi</td>
                        <td>
                            <input type="text" class="form-control" name="realisasi_sb5" id="realisasi_sb5" onkeyup="sb5();" minlength="8" required>
                        </td>
                    </tr>
                    <tr>
                        <td width="30%">Bobot </td>
                ...
                <?php if (!empty($getSarbis['desc_sarbis6'])) { ?>
                    <table class="table table-bordered" style="margin-top: 20px;">
                        ...
                        <tr>
                            <td width="30%">Realisasi</td>
                            <td>
                                <input type="text" class="form-control" name="realisasi_sb6" id="realisasi_sb6" onkeyup="sb6();" minlength="8" required>
                            </td>
                        </tr>
                        <tr>
                            <td width="30%">Bobot </td>
                ...
                <?php if (!empty($getSarbis['desc_sarbis7'])) { ?>
                    <table class="table table-bordered" style="margin-top: 20px;">
                        ...
                        <tr>
                            <td width="30%">Realisasi</td>
                            <td>
                                <input type="text" class="form-control" name="realisasi_sb7" id="realisasi_sb7" onkeyup="sb7();" minlength="8" required>
                            </td>
                        </tr>
                        <tr>
                            <td width="30%">Bobot </td>
                ...
                <?php } ?>
                <?php if (!empty($getSarbis['desc_sarbis8'])) { ?>
                    <table class="table table-bordered" style="margin-top: 20px;">
                        <tr>
                            <td colspan="2" style="font-weight:bold; text-align: center;background-color:#00A6B4; color: white;">
                                <b>SASARAN BISNIS/KINERJA 8</b>
                            </td>
                        </tr>
                        <tr>
                            <td width="30%">Uraian</td>
                            <td>
                                <?= $getSarbis['desc_sarbis8']; ?>
                                <input type="hidden" name="uraian_sb8" value="<?= $getSarbis['desc_sarbis8']; ?>">
                            </td>
                        </tr>
                        <tr>
                            <td width="30%">Realisasi</td>
                            <td>
                                <input type="text" class="form-control" name="realisasi_sb8" id="realisasi_sb8" onkeyup="sb8();" minlength="8" required>
                            </td>
                        </tr>
                        <tr>
                            <td width="30%">Bobot </td>
                            <td>
                                <input type="text" class="form-control" name="bobot_sb8" id="bobot_sb8" value="<?= $getSarbis['bobot_sarbis8']; ?>" onkeyup="sb8();" readonly>
                            </td>
                        </tr>
                        <tr>
                            <td width="30%">Nilai</td>
                            <td>
                                <select id="nilai_sb8" class="form-control" name="nilai_sb8" onkeyup="sb8();" onChange="sb8(this);">
                                    <option value="" hidden>-- Pilih Poin Penilaian --</option>
                                    <option value="1">1</option>
                                    <option value="2">2</option>
                                    <option value="3">3</option>
                        ...
                        <tr>
                            <td width="30%">Hasil</td>
                            <td>
                                <input type="text" class="form-control" name="hasil_sb8" id="hasil_sb8" readonly onkeyup="hasil_sb8();" onChange="sb8(this);">
                            </td>
                        </tr>
                    </table>
                <?php } ?>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <table class="table table-bordered" style="margin-bottom: 25px;">
                            <tr>
                                <td style="width: 40%;">Nilai NPF (%)<br><small>masukkan hanya berupa angka</small></td>
                                <td><input type="number" class="form-control" name="nilai_npf" id="nilai_npf" onkeyup="npf();" onChange="npf(this);" required></td>
                            </tr>
                            <tr>
                                <td style="width: 40%;">Nilai Audit<br /><br /></td>
                                <td>
                                    <select name="nilai_audit" class="form-control" id="nilai_audit" onkeyup="audit();" onChange="audit(this);" required>
                                        <option hidden value="">--Pilih Nilai Audit--</option>
                            ...
                            <tr>
                                <td style="width: 40%;">Nilai SMART<br><small><i>Specific, Measurable, Achievable, Relevant dan Time Bound</i></small></td>
                                <td>
                                    <select name="nilai_smart" class="form-control" id="nilai_smart" onkeyup="smart();" onChange="smart(this);" required>
                                        <option hidden value="">--Pilih Nilai SMART--</option>
                                        <option value="Baik">Baik</option>
                                        <option value="Cukup Baik">Cukup Baik</option>
                                        <option value="Kurang Baik">Kurang Baik</option>
                                        <option value="Tidak Baik">Tidak Baik</option>
                    ...
                    <div class="col-md-6">
                        <table class="table table-bordered" style="margin-bottom: 25px;">
                            <tr>
                                <td>Bobot NPF<br><small><i>nilai akan terisi otomatis</i></small></td>
                                <td><input type="number" class="form-control" name="bobot_npf" id="bobot_npf" readonly></td>
                            </tr>
                            <tr>
                                <td>Bobot Audit<br><small><i>nilai akan terisi otomatis</i></small></td>
                                <td><input type="number" class="form-control" name="bobot_audit" id="bobot_audit" readonly></td>
                            </tr>
                            <tr>
                                <td>Bobot SMART<br><small><i>nilai akan terisi otomatis</i><br /><br /></small></td>
                                <td><input type="number" class="form-control" name="bobot_smart" id="bobot_smart" readonly></td>
                            </tr>
                        </table>
                    </div>
                </div>
        ...
        <div class="card card-primary">
            ...
            <div class="card-body">
                ...
                <table class="table table-bordered" style="margin-bottom: 25px;">
                    ...
                    <tr>
                        <td colspan="3">
                            <input type="text" minlength="10" class="form-control" name="alasan_kupel" id="alasan_kupel" placeholder="Masukkan Alasan dan Contoh...">
                        </td>
                    </tr>
                </table>
                ...
                <table class="table table-bordered" style="margin-bottom: 25px;">
                    ...
                    <tr>
                        <td colspan="3">
                            <input type="text" minlength="10" class="form-control" name="alasan_disiplin" id="alasan_disiplin" placeholder="Masukkan Alasan dan Contoh...">
                        </td>
                    </tr>
                </table>
                ...
                <table class="table table-bordered" style="margin-bottom: 25px;">
                    ...
                    <tr>
                        <td colspan="3">
                            <input type="text" minlength="10" class="form-control" name="alasan_inisiatif" id="alasan_inisiatif" placeholder="Masukkan Alasan dan Contoh...">
                        </td>
                    </tr>
                </table>
                ...
                <table class="table table-bordered" style="margin-bottom: 25px;">
                    ...
                    <tr>
                        <td colspan="3">
                            <input type="text" minlength="10" class="form-control" name="alasan_integritas" id="alasan_integritas" placeholder="Masukkan Alasan dan Contoh...">
                        </td>
                    </tr>
                </table>
                ...
                <table class="table table-bordered" style="margin-bottom: 25px;">
                    ...
                    <tr>
                        <td colspan="3">
                            <input type="text" minlength="10" class="form-control" name="alasan_kerjasama" id="alasan_kerjasama" placeholder="Masukkan Alasan dan Contoh...">
                        </td>
                    </tr>
                </table>
                ...
                <table class="table table-bordered" style="margin-bottom: 25px;">
                    ...
                    <tr>
                        <td colspan="3">
                            <input type="text" minlength="10" class="form-control" name="alasan_mandiri" id="alasan_mandiri" placeholder="Masukkan Alasan dan Contoh...">
                        </td>
                    </tr>
                </table>
                ...
                <table class="table table-bordered" style="margin-bottom: 25px;">
                    ...
                    <tr>
                        <td colspan="3" style="font-weight:bold; text-align: center;background-color:#00A6B4; color: white;">
                            ...
                            <div class="float-right">
                                <i class="fas fa-info-circle" data-toggle='modal' data-target='#show' data-id='KEMAMPUAN MANAJERIAL'></i>
                            </div>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td>
                            <input type="text" class="form-control" value="<?= $bobot_kemampuan_manajerial ?>" name="bobot_kemampuan_manajerial" id="bobot_kemampuan_manajerial" onkeyup="kemampuan_manajerial();" readonly>
                        </td>
                        <td>
                            <select class="form-control" name="nilai_kemampuan_manajerial" id="nilai_kemampuan_manajerial" onkeyup="kemampuan_manajerial();" onChange="kemampuan_manajerial(this);" required>
                                <option value="" hidden>-- Pilih Poin Penilaian --</option>
                                <option value="1.00">1.00</option>
                                <option value="2.00">2.00</option>
                                <option value="3.00">3.00</option>
                        ...
                        <td>
                            <input type="text" class="form-control" value="" name="hasil_kemampuan_manajerial" id="hasil_kemampuan_manajerial" readonly>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="3" style="font-weight:bold">Alasan & Contoh</td>
                    ...
                    <tr>
                        <td colspan="3">
                            <input type="text" minlength="10" class="form-control" name="alasan_kemampuan_manajerial" id="alasan_kemampuan_manajerial" placeholder="Masukkan Alasan dan Contoh...">
                        </td>
                    </tr>
                </table>
            ...
            <div class="card-body">
                <table class="table table-bordered">
                    <tr>
                        ...
                        <td>
                            <input name="hal_menonjol" class="form-control" minlength="10" rows="1">
                        </td>
                    </tr>
                    <tr>
                        <td width="30%">Hal-Hal Yang Perlu Ditingkatkan</td>
                        <td>
                            <input name="hal_peningkatan" class="form-control" minlength="10" rows="1">
                        </td>
                    </tr>
                    <tr>
                        <td width="30%">Training/Pelatihan Yang Dibutuhkan</td>
                        <td>
                            <input type="text" class="form-control" name="req_training" id="req_training">
                        </td>
                    </tr>
                </table>
            </div>
...
<script>
    ...
    function npf() {
        var nilai = document.getElementById('nilai_npf').value;
        var bobot = (nilai >= 1) ? 0.50 : 0;
        if (!isNaN(bobot)) {
            document.getElementById('bobot_npf').value = bobot;
        }
    }

    function audit() {
        var nilai = document.getElementById('nilai_audit').value;
        var bobot = (nilai == 'Baik') ? 0 : (nilai == 'Cukup Baik') ? 0.25 : (nilai == 'Kurang Baik') ? 0.50 : 0.75;
        if (!isNaN(bobot)) {
            document.getElementById('bobot_audit').value = bobot;
        }
    }

    function smart() {
        var nilai = document.getElementById('nilai_smart').value;
        var bobot = (nilai == 'Baik') ? 0 : (nilai == 'Cukup Baik') ? 0.10 : 0.25;
        if (!isNaN(bobot)) {
            document.getElementById('bobot_smart').value = bobot;
        }
    }
</script>
<script>
