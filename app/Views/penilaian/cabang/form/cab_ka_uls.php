            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Penilaian Kepala ULS</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <section class="content">
        <div class="card card-primary">
            ...
            <div class="card-body" style="overflow-x: auto">
                <form action="<?= base_url('penilaian/process_kc/ka_uls') ?>" method="POST">
                    <?php csrf_field(); ?>
                    <?php
            ...
            <div class="card-body">
                ...
                <table class="table table-bordered" style="margin-top: 20px;">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" class="form-control" name="bobot_sb1" id="bobot_sb1" value="<?= $getSarbis['bobot_sarbis1']; ?>" onkeyup="sb1();" readonly>
                        </td>
                    </tr>
                    <tr>
