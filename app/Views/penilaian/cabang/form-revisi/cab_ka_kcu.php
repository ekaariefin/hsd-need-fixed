...
<div class="content-wrapper">
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h4>Revisi Penilaian Kinerja Kantor Cabang</h4>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item active">Penilaian Kepala Cabang Utama (KCU)</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <section class="content">
        <div class="card card-primary">
            ...
            <div class="card-body" style="overflow-x: auto">
                <form action="<?= base_url('penilaian/process_revisi_kc/ka_kcp') ?>" method="POST">
                    <?php csrf_field(); ?>
                    <?php
                ...
                <?php if (!empty($getData['uraian_sb7'])) { ?>
                    <table class="table table-bordered" style="margin-top: 20px;">
                        ...
                        <tr>
                            <td width="30%">Bobot </td>
                            <td>
                                <input type="text" class="form-control" name="bobot_sb7" id="bobot_sb7" value="<?= $getData['bobot_sb7']; ?>" onkeyup="sb7();" readonly>
                            </td>
                        </tr>
                        <tr>
                            <td width="30%">Nilai</td>
                ...
                <?php if (!empty($getData['uraian_sb8'])) { ?>
                    <table class="table table-bordered" style="margin-top: 20px;">
                        ...
                        <tr>
                            ...
                            <td>
                                <?= $getData['uraian_sb8']; ?>
                                <input type="hidden" name="uraian_sb8" value="<?= $getData['uraian_sb8']; ?>">
                            </td>
                        </tr>
                        <tr>
                            <td width="30%">Realisasi</td>
                            <td>
                                <input type="text" class="form-control" name="realisasi_sb8" id="realisasi_sb8" onkeyup="sb8();" value="<?= $getData['realisasi_sb8']; ?>">
                            </td>
                        </tr>
                        <tr>
                            <td width="30%">Bobot</td>
                            <td>
                                <input type="text" class="form-control" name="bobot_sb8" id="bobot_sb8" value="<?= $getData['bobot_sb8']; ?>" onkeyup="sb8();" readonly>
                            </td>
                        </tr>
                        <tr>
                            <td width="30%">Nilai</td>
                            <td>
                                <select id="nilai_sb8" class="form-control" name="nilai_sb8" onkeyup="sb8();" onChange="sb8(this);">
                                    <option value="<?= $getData['nilai_sb8']; ?>" selected hidden><?= $getData['nilai_sb8']; ?></option>
                                    <option value="1">1</option>
                                    <option value="2">2</option>
                                    <option value="3">3</option>
                                    <option value="4">4</option>
                        ...
                        <tr>
                            <td width="30%">Hasil</td>
                            <td>
                                <input type="text" class="form-control" name="hasil_sb8" value="<?= $getData['hasil_sb8']; ?>" id="hasil_sb8" readonly onkeyup="hasil_sb7();" onChange="sb8(this);">
                            </td>
                        </tr>
                    </table>
                <?php } ?>
                    ...
                    <div class="col-md-6">
                        <table class="table table-bordered" style="margin-bottom: 25px;">
                            <tr>
                                ...
                                <td><input type="number" class="form-control" name="nilai_npf" id="nilai_npf" value="<?= $getData['nilai_npf']; ?>" onkeyup="npf();" onChange="npf(this);" placeholder="Masukkan Nilai NPF" required></td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <select name="nilai_audit" class="form-control" id="nilai_audit" onkeyup="audit();" onChange="audit(this);" required>
                                        <option value="<?= $getData['nilai_audit']; ?>" selected hidden><?= $getData['nilai_audit']; ?></option>
                            ...
                            <tr>
                                ...
                                <td>
                                    <select name="nilai_smart" class="form-control" id="nilai_smart" onkeyup="smart();" onChange="smart(this);" required>
                                        <option value="<?= $getData['nilai_smart']; ?>" selected hidden><?= $getData['nilai_smart']; ?></option>
                                        <option value="Cukup Baik">Cukup Baik</option>
                                        <option value="Kurang Baik">Kurang Baik</option>
                                        <option value="Tidak Baik">Tidak Baik</option>
                                    </select>
                    ...
                    <div class="col-md-6">
                        <table class="table table-bordered" style="margin-bottom: 25px;">
                            <tr>
                                ...
                                <td><input type="number" class="form-control" name="bobot_npf" id="bobot_npf" value="<?= $getData['bobot_npf']; ?>" readonly></td>
                            </tr>
                            <tr>
                                <td>Bobot Audit<br><small><i>nilai akan terisi otomatis</i></small></td>
                                <td><input type="number" class="form-control" name="bobot_audit" value="<?= $getData['bobot_audit']; ?>" id="bobot_audit" readonly></td>
                            </tr>
                            <tr>
                                <td>Bobot SMART<br><small><i>nilai akan terisi otomatis</i><br /><br /></small></td>
                                <td><input type="number" class="form-control" name="bobot_smart" value="<?= $getData['bobot_smart']; ?>" id="bobot_smart" readonly></td>
                            </tr>
                        </table>
                    </div>
                </div>
        ...
        <div class="card card-primary">
            ...
            <div class="card-body">
                ...
                <table class="table table-bordered" style="margin-bottom: 25px;">
                    ...
                    <tr>
                        <td>
                            <input type="text" class="form-control" value="<?= $getData['bobot_kupel'] ?>" name="bobot_kupel" id="bobot_kupel" onkeyup="kupel();" readonly>
                        </td>
                        <td>
                ...
                <table class="table table-bordered" style="margin-bottom: 25px;">
                    ...
                    <tr>
                        <td>
                            <input type="text" class="form-control" value="<?= $getData['bobot_disiplin'] ?>" name="bobot_disiplin" id="bobot_disiplin" onkeyup="disiplin();" readonly>
                        </td>
                        <td>
                ...
                <table class="table table-bordered" style="margin-bottom: 25px;">
                    ...
                    <tr>
                        <td>
                            <input type="text" class="form-control" value="<?= $getData['bobot_inisiatif'] ?>" name="bobot_inisiatif" id="bobot_inisiatif" onkeyup="inisiatif();" readonly>
                        </td>
                        <td>
                ...
                <table class="table table-bordered" style="margin-bottom: 25px;">
                    ...
                    <tr>
                        <td>
                            <input type="text" class="form-control" value="<?= $getData['bobot_integritas'] ?>" name="bobot_integritas" id="bobot_integritas" onkeyup="integritas();" readonly>
                        </td>
                        <td>
                ...
                <table class="table table-bordered" style="margin-bottom: 25px;">
                    ...
                    <tr>
                        <td>
                            <input type="text" class="form-control" value="<?= $getData['bobot_kerjasama'] ?>" name="bobot_kerjasama" id="bobot_kerjasama" onkeyup="kerjasama();" readonly>
                        </td>
                        <td>
                ...
                <table class="table table-bordered" style="margin-bottom: 25px;">
                    ...
                    <tr>
                        <td>
                            <input type="text" class="form-control" value="<?= $getData['bobot_mandiri']; ?>" name="bobot_mandiri" id="bobot_mandiri" onkeyup="mandiri();" readonly>
                        </td>
                        <td>
                ...
                <table class="table table-bordered" style="margin-bottom: 25px;">
                    ...
                    <tr>
                        <td>
                            <input type="text" class="form-control" value="<?= $getData['bobot_kemampuan_manajerial']; ?>" name="bobot_kemampuan_manajerial" id="bobot_kemampuan_manajerial" onkeyup="kemampuan_manajerial();" readonly>
                        </td>
                        <td>
                            <select class="form-control" name="nilai_kemampuan_manajerial" id="nilai_kemampuan_manajerial" onkeyup="kemampuan_manajerial();" onChange="kemampuan_manajerial(this);" required>
                                <option value="<?= $getData['nilai_kemampuan_manajerial']; ?>" selected hidden><?= $getData['nilai_kemampuan_manajerial']; ?></option>
                                <option value="1.00">1.00</option>
                                <option value="2.00">2.00</option>
                                <option value="3.00">3.00</option>
                                <option value="4.00">4.00</option>
                        ...
                        <td>
                            <input type="text" class="form-control" value="<?= $getData['hasil_kemampuan_manajerial']; ?>" name="hasil_kemampuan_manajerial" id="hasil_kemampuan_manajerial" readonly>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="3" style="font-weight:bold">Alasan & Contoh</td>
                    ...
                    <tr>
                        <td colspan="3">
                            <textarea type="text" class="form-control" name="alasan_kemampuan_manajerial" id="alasan_kemampuan_manajerial" placeholder="Masukkan Alasan dan Contoh...">
                                <?= $getData['alasan_kemampuan_manajerial']; ?>
                            </textarea>
                        </td>
                    </tr>
                </table>
...
<script>
    ...
    function audit() {
        ...
        var bobot = (nilai == 'Cukup Baik') ? 0.25 : (nilai == 'Kurang Baik') ? 0.50 : 0.75;
        if (!isNaN(bobot)) {
    ...
    function smart() {
        ...
        var bobot = (nilai == 'Cukup Baik') ? 0.10 : 0.25;
        if (!isNaN(bobot)) {
