            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Kantor Cabang Gol. 1, 2 & 3</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <section class="content">
        ...
        <div class="card card-primary">
            ...
            <div class="card-body" style="overflow-x: auto">
                <form action="<?= base_url('penilaian/process_revisi_kc/123') ?>" method="POST">
                    <?php
        ...
        <div class="card card-primary">
            <div class="card-header">
                <div class="card-title">
                    Revisi Penilaian Kecakapan Kerja
                </div>
            </div>
            <div class="card-body">
                <!-- Pengetahuan Jabatan -->
                <table class="table table-bordered" style="margin-bottom: 25px;">
                    ...
                    <tr>
                        <td colspan="3">
                            <textarea type="text" class="form-control" name="alasan_pengetahuan_jabatan" id="alasan_pengetahuan_jabatan" placeholder="Masukkan Alasan dan Contoh..."><?= $getData['alasan_pengetahuan_jabatan']; ?></textarea>
                        </td>
                    </tr>
                </table>
                    ...
                    <tr>
                        ...
                        <td>
                            <select id="nilai_kualitas_kerja" class="form-control" name="nilai_kualitas_kerja" onkeyup="kualitas_kerja();" onChange="kualitas_kerja(this);" required>
                                <option value="<?= $getData['nilai_kualitas_kerja']; ?>" selected hidden><?= $getData['nilai_kualitas_kerja']; ?></option>
                                <option value="1.00">1.00</option>
                                <option value="2.00">2.00</option>
                                <option value="3.00">3.00</option>
                                <option value="4.00">4.00</option>
                        ...
                        <td>
                            <input type="text" class="form-control" name="hasil_kualitas_kerja" id="hasil_kualitas_kerja" value="<?= $getData['hasil_kualitas_kerja']; ?>" readonly onkeyup="kecakapan_kerja();" onChange="kecakapan_kerja(this);">
                        </td>
                    </tr>
                    <tr>
                        <td colspan="3" style="font-weight: bold;">Alasan & Contoh</td>
                ...
                <table class="table table-bordered" style="margin-bottom: 25px;">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" class="form-control" name="hasil_adaptasi" value="<?= $getData['hasil_adaptasi']; ?>" id="hasil_adaptasi" readonly onkeyup="kecakapan_kerja();" onChange="kecakapan_kerja(this);">
                        </td>
                    </tr>
                    <tr>
                        <td colspan="3" style="font-weight:bold;">Alasan & Contoh</td>
                    ...
                    <tr>
                        <td colspan="3">
                            <textarea type="text" class="form-control" name="alasan_adaptasi" id="alasan_adaptasi" placeholder="Masukkan Alasan dan Contoh..."><?= $getData['alasan_adaptasi']; ?></textarea>
                        </td>
                    </tr>
                </table>
                ...
                <table class="table table-bordered" style="margin-bottom: 25px;">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" class="form-control" name="hasil_kemampuan_komunikasi" value="<?= $getData['hasil_kemampuan_komunikasi']; ?>" id="hasil_kemampuan_komunikasi" readonly>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="3" style="font-weight:bold;">Alasan & Contoh</td>
