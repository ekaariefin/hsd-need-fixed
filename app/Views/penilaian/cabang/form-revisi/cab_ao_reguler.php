    ...
    <section class="content">
        <div class="card card-primary">
            ...
            <div class="card-body" style="overflow-x: auto">
                <form action="<?= base_url('penilaian/process_revisi_kc/ao_reg') ?>" method="POST">
                    <?php csrf_field(); ?>
                    <?php
                    ...
                    <div class="col-md-6">
                        <table class="table table-bordered" style="margin-bottom: 25px;">
                            <tr>
                                ...
                                <td><input type="number" class="form-control" name="nilai_npf" value="<?= $getData['nilai_npf']; ?>" id="nilai_npf" onkeyup="npf();" onChange="npf(this);" required></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <select name="nilai_dok" class="form-control" id="nilai_dok" onkeyup="dok();" onChange="dok(this);" required>
                                        <option value="<?= $getData['nilai_dok']; ?>" selected hidden><?= $getData['nilai_dok']; ?></option>
                    ...
                    <div class="col-md-6">
                        <table class="table table-bordered" style="margin-bottom: 25px;">
                            ...
                            <tr>
                                ...
                                <td><input type="number" class="form-control" name="bobot_audit" id="bobot_audit" value="<?= $getData['bobot_audit']; ?>" readonly></td>
                            </tr>
                            <tr>
                                <td>Bobot Dok Hilang<br><small><i>nilai akan terisi otomatis</i></small></td>
                                <td><input type="number" class="form-control" name="bobot_dok" id="bobot_dok" value="<?= $getData['bobot_dok']; ?>" readonly></td>
                            </tr>
                        </table>
                    </div>
                </div>
