            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Kantor Cabang Golongan 4 Struktural</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <section class="content">
        ...
        <div class="card card-primary">
            ...
            <div class="card-body" style="overflow-x: auto">
                <form action="<?= base_url('penilaian/process_revisi_kc/4S') ?>" method="POST">
                    <?php
        ...
        <div class="card card-primary">
            ...
            <div class="card-body">
                ...
                <table class="table table-bordered" style="margin-bottom: 25px;">
                    ...
                    <tr>
                        ...
                        <td>
                            <select id="nilai_pengetahuan_jabatan" class="form-control" name="nilai_pengetahuan_jabatan" onkeyup="pengetahuan_jabatan();" onChange="pengetahuan_jabatan(this);" required>
                                <option value="<?= $getData['nilai_pengetahuan_jabatan']; ?>" selected hidden><?= $getData['nilai_pengetahuan_jabatan']; ?></option>
                        ...
                        <td>
                            <input type="text" class="form-control" name="hasil_pengetahuan_jabatan" id="hasil_pengetahuan_jabatan" value="<?= $getData['hasil_pengetahuan_jabatan']; ?>" readonly onkeyup="kecakapan_kerja();" onChange="kecakapan_kerja(this);">
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan="3">
                            <textarea type="text" class="form-control" name="alasan_pengetahuan_jabatan" id="alasan_pengetahuan_jabatan" placeholder="Masukkan Alasan dan Contoh...">
                                <?= $getData['alasan_pengetahuan_jabatan']; ?>
                            </textarea>
                        </td>
                    </tr>
                </table>
                ...
                <table class="table table-bordered" style="margin-bottom: 25px;">
                    ...
                    <tr>
                        ...
                        <td>
                            <select id="nilai_kualitas_kerja" class="form-control" name="nilai_kualitas_kerja" onkeyup="kualitas_kerja();" onChange="kualitas_kerja(this);" required>
                                <option value="<?= $getData['nilai_kualitas_kerja']; ?>" hidden><?= $getData['nilai_kualitas_kerja']; ?></option>
                                <option value="1.00">1.00</option>
                                <option value="2.00">2.00</option>
                                <option value="3.00">3.00</option>
                                <option value="4.00">4.00</option>
                        ...
                        <td>
                            <input type="text" class="form-control" value="<?= $getData['hasil_kualitas_kerja']; ?>" name="hasil_kualitas_kerja" id="hasil_kualitas_kerja" readonly onkeyup="kecakapan_kerja();" onChange="kecakapan_kerja(this);">
                        </td>
                    </tr>
                    <tr>
                        <td colspan="3" style="font-weight: bold;">Alasan & Contoh</td>
                    ...
                    <tr>
                        <td colspan="3">
                            <textarea type="text" class="form-control" name="alasan_kualitas_kerja" id="alasan_kualitas_kerja" placeholder="Masukkan Alasan dan Contoh...">
                                <?= $getData['hasil_kualitas_kerja']; ?>
                            </textarea>
                        </td>
                    </tr>
                </table>
                ...
                <table class="table table-bordered" style="margin-bottom: 25px;">
                    ...
                    <tr>
                        ...
                        <td>
                            <select class="form-control" name="nilai_adaptasi" id="nilai_adaptasi" onkeyup="adaptasi();" onChange="adaptasi(this);" required>
                                <option value="<?= $getData['nilai_adaptasi']; ?>" selected hidden><?= $getData['nilai_adaptasi']; ?></option>
                                <option value="1.00">1.00</option>
                                <option value="2.00">2.00</option>
                                <option value="3.00">3.00</option>
                                <option value="4.00">4.00</option>
                        ...
                        <td>
                            <input type="text" class="form-control" value="<?= $getData['hasil_adaptasi']; ?>" name="hasil_adaptasi" id="hasil_adaptasi" readonly onkeyup="kecakapan_kerja();" onChange="kecakapan_kerja(this);">
                        </td>
                    </tr>
                    <tr>
                        <td colspan="3" style="font-weight:bold;">Alasan & Contoh</td>
                    ...
                    <tr>
                        <td colspan="3">
                            <textarea type="text" class="form-control" name="alasan_adaptasi" id="alasan_adaptasi" placeholder="Masukkan Alasan dan Contoh...">
                                <?= $getData['alasan_adaptasi']; ?>
                            </textarea>
                        </td>
                    </tr>
                </table>
                ...
                <table class="table table-bordered" style="margin-bottom: 25px;">
                    ...
                    <tr>
                        ...
                        <td>
                            <select class="form-control" name="nilai_kemampuan_komunikasi" id="nilai_kemampuan_komunikasi" onkeyup="kemampuan_komunikasi();" onChange="kemampuan_komunikasi(this);" required>
                                <option value="<?= $getData['nilai_kemampuan_komunikasi']; ?>" selected hidden><?= $getData['nilai_kemampuan_komunikasi']; ?></option>
                                <option value="1.00">1.00</option>
                                <option value="2.00">2.00</option>
                                <option value="3.00">3.00</option>
                                <option value="4.00">4.00</option>
                        ...
                        <td>
                            <input type="text" class="form-control" value="<?= $getData['hasil_kemampuan_komunikasi']; ?>" name="hasil_kemampuan_komunikasi" id="hasil_kemampuan_komunikasi" readonly>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="3" style="font-weight:bold;">Alasan & Contoh</td>
                    ...
                    <tr>
                        <td colspan="3">
                            <textarea type="text" class="form-control" name="alasan_kemampuan_komunikasi" id="alasan_kemampuan_komunikasi" placeholder="Masukkan Alasan dan Contoh...">
                                <?= $getData['alasan_kemampuan_komunikasi']; ?>
                            </textarea>
                        </td>
                    </tr>
                </table>
        ...
        <div class="card card-primary">
            ...
            <div class="card-body">
                    ...
                    <tr>
                        ...
                        <td>
                            <select class="form-control" name="nilai_inisiatif" id="nilai_inisiatif" onkeyup="inisiatif();" onChange="inisiatif(this);" required>
                                <option value="<?= $getData['nilai_inisiatif']; ?>" selected hidden>-- Pilih Poin Penilaian --</option>
                                <option value="1.00">1.00</option>
                                <option value="2.00">2.00</option>
                                <option value="3.00">3.00</option>
                                <option value="4.00">4.00</option>
                ...
                <table class="table table-bordered" style="margin-bottom: 25px;">
                    ...
                    <tr>
                        <td>
                            <input type="text" class="form-control" value="<?= $bobot_mandiri ?>" name="bobot_kemampuan_manajerial" id="bobot_kemampuan_manajerial" onkeyup="kemampuan_manajerial();" readonly>
                        </td>
                        <td>
