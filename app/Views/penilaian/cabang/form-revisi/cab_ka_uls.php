        ...
        <div class="card card-primary">
            ...
            <div class="card-body">
                ...
                <table class="table table-bordered" style="margin-bottom: 25px;">
                    ...
                    <tr>
                        <td>
                            <input type="text" class="form-control" value="<?= $bobot_kerjasama ?>" name="bobot_kemampuan_manajerial" id="bobot_kemampuan_manajerial" onkeyup="kemampuan_manajerial();" readonly>
                        </td>
                        <td>
