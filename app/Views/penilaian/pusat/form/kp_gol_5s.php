    ...
    <section class="content">
        <div class="card card-primary">
            ...
            <div class="card-body" style="overflow-x: auto">
                <form action="<?= base_url('penilaian/process_kp/5S') ?>" method="POST">
                    <?php csrf_field(); ?>
                    <?php
            ...
            <div class="card-body">
                ...
                <table class="table table-bordered" style="margin-top: 20px;">
                    ...
                    <tr>
                        <td width="30%">Bobot </td>
                        <td>
                            <input type="text" class="form-control" name="bobot_sb2" id="bobot_sb2" value="<?= $getSarbis['bobot_sarbis1']; ?>" readonly onkeyup="sb5();">
                        </td>
                    </tr>
                    <tr>
                        <td width="30%">Nilai</td>
