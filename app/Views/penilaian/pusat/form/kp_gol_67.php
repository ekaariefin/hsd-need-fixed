            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Penilaian Gol. 6 & 7</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <section class="content">
        <div class="card card-primary">
            ...
            <div class="card-body" style="overflow-x: auto">
                <form action="<?= base_url('penilaian/process_kp/67') ?>" method="POST">
                    <?php csrf_field(); ?>
                    <?php
            ...
            <div class="card-body">
                ...
                <table class="table table-bordered" style="margin-top: 20px;">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" class="form-control" name="realisasi_sb1" id="realisasi_sb1" onkeyup="sb1();">
                        </td>
                    </tr>
                    <tr>
                ...
                <table class="table table-bordered" style="margin-top: 20px;">
                    ...
                    <tr>
                        <td width="30%">Realisasi</td>
                        <td>
                            <input type="text" class="form-control" name="realisasi_sb2" id="realisasi_sb2" onkeyup="sb2();">
                        </td>
                    </tr>
                    <tr>
                        <td width="30%">Bobot </td>
                ...
                <table class="table table-bordered" style="margin-top: 20px;">
                    ...
                    <tr>
                        <td width="30%">Realisasi</td>
                        <td>
                            <input type="text" class="form-control" name="realisasi_sb3" id="realisasi_sb3" onkeyup="sb3();">
                        </td>
                    </tr>
                    <tr>
                        <td width="30%">Bobot </td>
                ...
                <table class="table table-bordered" style="margin-top: 20px;">
                    ...
                    <tr>
                        <td width="30%">Realisasi</td>
                        <td>
                            <input type="text" class="form-control" name="realisasi_sb4" id="realisasi_sb4" onkeyup="sb4();">
                        </td>
                    </tr>
                    <tr>
                        <td width="30%">Bobot </td>
                ...
                <table class="table table-bordered" style="margin-top: 20px;">
                    ...
                    <tr>
                        <td width="30%">Realisasi</td>
                        <td>
                            <input type="text" class="form-control" name="realisasi_sb5" id="realisasi_sb5" onkeyup="sb5();">
                        </td>
                    </tr>
                    <tr>
                        <td width="30%">Bobot </td>
                ...
                <?php if (!empty($getSarbis['desc_sarbis6'])) { ?>
                    <table class="table table-bordered" style="margin-top: 20px;">
                        ...
                        <tr>
                            <td width="30%">Realisasi</td>
                            <td>
                                <input type="text" class="form-control" name="realisasi_sb6" id="realisasi_sb6" onkeyup="sb6();">
                            </td>
                        </tr>
                        <tr>
                            <td width="30%">Bobot </td>
                ...
                <?php if (!empty($getSarbis['desc_sarbis7'])) { ?>
                    <table class="table table-bordered" style="margin-top: 20px;">
                        ...
                        <tr>
                            <td width="30%">Realisasi</td>
                            <td>
                                <input type="text" class="form-control" name="realisasi_sb7" id="realisasi_sb7" onkeyup="sb7();">
                            </td>
                        </tr>
                        <tr>
                            <td width="30%">Bobot </td>
        ...
        <div class="card card-primary">
            ...
            <div class="card-body">
                ...
                <table class="table table-bordered" style="margin-bottom: 25px;">
                    ...
                    <tr>
                        <td colspan="3">
                            <input type="text" minlength="10" class="form-control" name="alasan_kupel" id="alasan_kupel" placeholder="..." minlength="10" required>
                        </td>
                    </tr>
                </table>
                ...
                <table class="table table-bordered" style="margin-bottom: 25px;">
                    ...
                    <tr>
                        <td colspan="3">
                            <input type="text" minlength="10" class="form-control" name="alasan_disiplin" id="alasan_disiplin" placeholder="..." minlength="10" required>
                        </td>
                    </tr>
                </table>
                ...
                <table class="table table-bordered" style="margin-bottom: 25px;">
                    ...
                    <tr>
                        <td colspan="3">
                            <input type="text" minlength="10" class="form-control" name="alasan_inisiatif" id="alasan_inisiatif" placeholder="..." required>
                        </td>
                    </tr>
                </table>
                ...
                <table class="table table-bordered" style="margin-bottom: 25px;">
                    ...
                    <tr>
                        <td colspan="3">
                            <input type="text" minlength="10" class="form-control" name="alasan_integritas" id="alasan_integritas" placeholder="..." minlength="10" required>
                        </td>
                    </tr>
                </table>
                ...
                <table class="table table-bordered" style="margin-bottom: 25px;">
                    ...
                    <tr>
                        <td colspan="3">
                            <input type="text" minlength="10" class="form-control" name="alasan_kerjasama" id="alasan_kerjasama" placeholder="..." minlength="10" required>
                        </td>
                    </tr>
                </table>
                ...
                <table class="table table-bordered" style="margin-bottom: 25px;">
                    ...
                    <tr>
                        <td colspan="3">
                            <input type="text" minlength="10" class="form-control" name="alasan_mandiri" id="alasan_mandiri" placeholder="..." minlength="10" required>
                        </td>
                    </tr>
                </table>
                ...
                <table class="table table-bordered" style="margin-bottom: 25px;">
                    ...
                    <tr>
                        <td colspan="3">
                            <input type="text" minlength="10" class="form-control" name="alasan_kemampuan_manajerial" id="alasan_kemampuan_manajerial" placeholder="..." minlength="10" required>
                        </td>
                    </tr>
                </table>
