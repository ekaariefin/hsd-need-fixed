...
<table class="table table-bordered" style="margin-bottom: 20px">
    ...
    <tr>
        ...
        <td style="text-align: center"><?= $x['total_sarbis']; ?></td>
        <td style="text-align: center">0.70</td>
        <td style="text-align: center"><?= $x['hasil_sarbis']; ?></td>
    </tr>
</table>