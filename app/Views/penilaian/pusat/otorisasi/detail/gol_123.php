        ...
        <div class="card">
            <div class="card-body">
                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        <td>Nilai : <?= $x['nilai_kupel']; ?><br/> 
                            Bobot : <?= $x['bobot_kupel']; ?><br/>
                            Hasil : <?= round($x['hasil_kupel'],3); ?>
                        </td>
                    ...
                    <tr>
                        <td>
                            ...
                            if($x['penilai_satu'] == session()->get('fnip') AND $x['approval_satu'] == ''){
                                echo "<a type='button' href='".base_url('penilaian/otorisasi/OtorisasiPenilaian/oto_gol_123/'.$x['id_pn'].'/'.$updated_to.'')."' class='btn btn-success'><i class='fa fa-check-double' style='margin-right:5px;'></i> Otorisasi</a>
