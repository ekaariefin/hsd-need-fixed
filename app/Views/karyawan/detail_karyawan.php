                        ...
                        <table class="table" style="border: none;">
                            <tr style="border: none;">
                                <td class="d-flex justify-content-end" style="border: none;">
                                    <a href="<?= base_url() ?>/karyawan/edit/karyawan/<?= $info['fnip']; ?>" type="button" id="BtnEdit" class="btn btn-warning "> <b><i class="fas fa-edit" style="margin-right: 5px;"></i>Ubah Data Karyawan</b></a>
                                </td>
                            </tr>
                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        ...
                        <table class="table" style="border: none;">
                            <tr style="border: none;">
                                <td class="d-flex justify-content-end" style="border: none;">
                                    <a href="<?= base_url() ?>/karyawan/edit/atasan/<?= $info['fnip']; ?>" type="button" id="BtnEdit" class="btn btn-warning"> <b><i class="fas fa-edit" style="margin-right: 5px;"></i>Ubah Atasan</b></a>
                                </td>
                            </tr>
                        </table>
                    </div>
